...
The combination of these logical gates results in very low level instructions, such as STORE, LOAD, ADD, or COMPARE.
%TODO add screenshot with logic gates to add two numbers
