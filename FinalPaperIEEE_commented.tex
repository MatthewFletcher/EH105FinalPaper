...
%http://mathworld.wolfram.com/TravelingSalesmanProblem.html
 In math terms, this problem is attempting to find the most efficient Hamiltonian Cycle to take through a set of N nodes. This has a real life application, however; finding the shortest route between a set of points is nothing more than a navigation application such as google maps. Google is actually looking into the use of 
 \\
 \\
